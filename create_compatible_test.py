# Create this file: create_compatible_test.py
import os


def create_compatible_test():
    """Create a new test file that works with your implementation"""
    test_content = '''
import unittest
import sys
import os
...
'''
    ...
    with open(
        "tests/test_clarification_module_compatible.py", "w", encoding="utf-8"
    ) as f:
        f.write(test_content)

    print("Created compatible test file: tests/test_clarification_module_compatible.py")
    print("\nRun the compatible tests with:")
    print("python -m tests.test_clarification_module_compatible")


if __name__ == "__main__":
    create_compatible_test()
